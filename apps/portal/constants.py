...
NAV_ITEMS: tuple[NavigationItem, ...] = (
    ...
    NavigationItem("Inventory", permission="inventory.view", section=SECTION_OPERATIONS, icon="I", children=(
        NavigationItem("Classes", permission="inventory.view", url_name="inventory:class_list"),
        NavigationItem("UOMs", permission="inventory.view", url_name="inventory:uom_list"),
        NavigationItem("UOM Conversions", permission="inventory.view", url_name="inventory:conversion_list"),
        NavigationItem("Vendors", permission="inventory.view", url_name="inventory:vendor_list"),
        ...
        NavigationItem("Customers", permission="inventory.view", url_name="inventory:customer_list"),
        NavigationItem("POS Sales", permission="inventory.view", url_name="inventory:pos_list"),
        NavigationItem("POS Returns", permission="inventory.view", url_name="inventory:pos_return_list"),
        NavigationItem("Purchase Returns", permission="inventory.view", url_name="inventory:purchase_return_list"),
