...
OPTIONAL_FIELDS: tuple[OptionalField, ...] = (
    ...
    OptionalField("godown", "Godown", "Header",
                  "Where the goods are expected. Recorded on the order; stock is one pool per item."),
    OptionalField("broker", "Broker", "Header"),
...
INVOICE_OPTIONAL_FIELDS: tuple[OptionalField, ...] = (
    ...
    OptionalField("vehicle_no", "Vehicle no", "Header"),
    OptionalField("broker", "Broker", "Header"),
    OptionalField("line_uom", "Unit column", "Lines",
                  "Off, every line is written in the item's own unit."),
    OptionalField("line_stock", "Stock in hand chip", "Lines"),
