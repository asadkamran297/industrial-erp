...
_STATIC_PAGES: tuple[Page, ...] = (
    ...
    Page("reports.owner", "Owner Reports", "Reports", LIST_ONLY),
    Page("reports.sales", "Sales Reports", "Reports", LIST_ONLY),
    Page("reports.purchase", "Purchase Reports", "Reports", LIST_ONLY),
    Page("reports.weighbridge", "Weighbridge Reports", "Reports", LIST_ONLY),
    Page("reports.bardana", "Bardana Reports", "Reports", LIST_ONLY),
    Page("reports.stock", "Stock Reports", "Reports", LIST_ONLY),
    Page("reports.accounts", "Accounts Reports", "Reports", LIST_ONLY),
    Page("reports.hr", "HR Reports", "Reports", LIST_ONLY),
    ...
    Page("godowns.godowns", "Godowns", "Master Data", MASTER_NO_DELETE),
