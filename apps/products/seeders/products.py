...
ITEMS = (
    ...
    ("02-01-003", "Atta Zafaran 15 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 15),
    ("02-01-004", "Atta Diamond 20 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 20),
    ("02-01-005", "Atta Zafaran 5 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 5),
    ("02-01-006", "Atta Chakki 40 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 40),
    ("02-02-001", "S.Fine Zafaran 50 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 50),
    ("02-03-014", "Maida Diamond 80 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 80),
    ("02-04-001", "Fine Diamond 80 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 80),
    ("02-04-002", "Fine Zafaran 50 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 50),
    ("02-05-001", "Suji Zafaran 50 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_PIECE, 50),
    ("02-05-002", "Suji Zafaran 01 kg", PRD_SPEC_FINISH_ITEM, PRD_UNIT_KG, 1),
    ("02-06-001", "Bran (Choker) 49 kg", PRD_SPEC_BYPRODUCT, PRD_UNIT_PIECE, 49),
    ("02-06-002", "Bran 20 kg", PRD_SPEC_BYPRODUCT, PRD_UNIT_PIECE, 20),
    ("02-06-003", "Bran (Choker) Loose", PRD_SPEC_BYPRODUCT, PRD_UNIT_KG, 1),
    ("02-07-001", "Refraction (Sweepings)", PRD_SPEC_BYPRODUCT, PRD_UNIT_KG, 1),
    ("02-07-002", "Broken Wheat (Dalia)", PRD_SPEC_BYPRODUCT, PRD_UNIT_KG, 1),
